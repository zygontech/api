...
export async function process({
  ...
  // Create a Jira issue for deprovisioning the user
    ...
    options: {
      ...
      body: {
        fields: {
          ...
          summary: `Revoke access for ${target.fullName || target.primaryEmail} to ${app.name}`,
          description: {
            type: "doc",
            version: 1,
            content: [
          ...
          issuetype: { name: "Task" },
          labels: ["zygon-sync", "deprovisioning"],
        },
      },
    },
  });
